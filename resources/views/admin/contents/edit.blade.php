        ...
        <form action="{{url('/admin/contents/index')}}" method="post">
            ...
            <table class="add_tab">
                        ...
                        <select name="_pid">
                            ...
                            @foreach($_name as $name)
                                <option value="{{$name->_id}}"
                                        @if($name->_id==$content->_pid) selected @endif
                                >{{$name->_type}}</option>
                            @endforeach
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="_type" value="{{$content->_type}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="_title" value="{{$content->_title}}">
                    </td>
                </tr>
                <tr>
                    <th>关键词：</th>
                    <td>
                        <textarea name="_keywords" value="{{$content->_keywords}}"></textarea>
                    </td>
                </tr>
                <tr>
                    <th>详细内容：</th>
                ...
                <tr>
                    <th>排序：</th>
                    <td>
                        <input type="text" class="sm" name="_order" value="{{$content->_order}}">
                        <span><i class="fa fa-exclamation-circle yellow"></i>必填</span>
                    </td>
                <tr>
                    <th></th>
