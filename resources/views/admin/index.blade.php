...
<body>
	...
	<div class="top_box">
		...
		<div class="top_right">
			<ul>
				<li>管理员：admin</li>
				<li><a href="{{url('/admin/passwdreset')}}" target="main">修改密码</a></li>
	...
	<div class="menu_box">
		<ul>
			<li>
				...
				<ul class="sub_menu">
					<li><a href="{{url('/admin/contents/index/create')}}" target="main"><i
									class="fa fa-fw fa-plus-square"></i>添加分类</a></li>
					<li><a href="{{url('/admin/contents/index')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>全部分类</a>
					</li>
