...
<div class="row clealfix">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <button type="button" class="btn btn-primary theme-bg btn-toastr" data-context="info" data-message="This is general theme info" data-position="bottom-right">General Info</button>
