                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary theme-bg">Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <button type="button" class="btn btn-primary theme-bg" data-toggle="modal" data-target=".new-project-modal">Setup New Project</button>
                            ...
                            <div class="modal-body">
                                <div class="d-flex mb-3">
                                    <div class="icon bg-transparent">
                                        <img src="{{ asset('assets/images/user-small.png') }}" class="rounded mr-3 w40" alt="">
                                    </div>
                                    <div>
